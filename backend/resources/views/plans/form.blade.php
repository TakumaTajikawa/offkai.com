@csrf
<div class="md-form">
  <label>タイトル <span style="font-size: 7px; color: #fff; background-color: #FF367F; border-radius: 5px; padding: 2px;">※必須</span></label>
...
<div class="form-group">
  <label>開催日時 <span style="font-size: 7px; color: #fff; background-color: #FF367F; border-radius: 5px; padding: 2px;">※必須</span></label>
...
<div class="form-group">
  <label>都道府県 <span style="font-size: 7px; color: #fff; background-color: #FF367F; border-radius: 5px; padding: 2px;">※必須</span></label>
...
<div class="form-group">
  <label>説明 <span style="font-size: 7px; color: #fff; background-color: #FF367F; border-radius: 5px; padding: 2px;">※必須</span></label>
