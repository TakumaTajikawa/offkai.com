...
<div class="form-group">
  ...
  <select type="text" required class="form-control" name="prefecture" required value="{{ $plan->prefecture ?? old('prefecture') }}">
...
<div class="md-form">
  <label>場所（区市町村）</label>
  <input type="text" name="cities" class="form-control" required value="{{ $plan->cities ?? old('cities') }}">
</div>

<div class="md-form">
  <label>会場</label>
  <input type="text" name="venue" class="form-control" required value="{{ $plan->venue ?? old('venue') }}">
</div>

<div class="md-form">
  <label>会費</label>
  <input type="text" name="membership_fee" class="form-control" required value="{{ $plan->membership_fee ?? old('membership_fee') }}">
</div>

<div class="md-form">
  <label>募集年齢</label>
  <input type="text" name="age" class="form-control" required value="{{ $plan->age ?? old('age') }}">
</div>

<div class="md-form">
  <label>ジャンル</label>
  <input type="text" name="genre" class="form-control" required value="{{ $plan->genre ?? old('genre') }}">
</div>
